...
function meal_process_reservation(){
	...
	if(check_ajax_referer('reservation','reservation')){
		$name    = sanitize_text_field( $_POST['name'] );
		$email   = sanitize_text_field( $_POST['email'] );
		$persons = sanitize_text_field( $_POST['persons'] );
		$phone   = sanitize_text_field( $_POST['phone'] );
...
add_action("wp_ajax_reservation","meal_process_reservation"); // wp_ajax arpor ajax ar action dite hobe
add_action("wp_ajax_nopriv_reservation","meal_process_reservation");
